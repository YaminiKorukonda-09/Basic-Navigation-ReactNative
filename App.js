...
import Set from './DrawerScreens/Set';
import {DrawerContent} from './Screens/DrawerContent';
import Bell from './DrawerScreens/Bell';
import Queries from './DrawerScreens/Queries';
import LI from './Ecg/LI';
import LII from './Ecg/LII';
import V1 from './Ecg/V1';
import V2 from './Ecg/V2';
import V3 from './Ecg/V3';
import V4 from './Ecg/V4';
import V5 from './Ecg/V5';
import V6 from './Ecg/V6';
