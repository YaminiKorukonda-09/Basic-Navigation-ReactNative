...
const Ecg =() => {
  ...
  return(
    <View style = {styles.header}>
          <Image source={require('../Images/ReturnBack.jpeg')} style={{width:50,height:37,marginTop:3, marginRight:11}}></Image>
  ...
  return(
    ...
    >
      <View style={styles.boxContainer}>
        ...
        <Image source={require('../Images/LeadPosition.jpeg')} style={styles.leadposition}></Image>
      </View>
