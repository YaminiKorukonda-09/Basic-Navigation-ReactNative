  ...
  const Header = () =>{
    return(
      <View style = {styles.header}>
          <Image source={require('../Images/Return.jpeg')} style={{width:50,height:37,marginTop:10, marginRight:11}}></Image>
        ...
        <View style ={styles.box1}>
          <View style ={styles.inner1}>
            <Text style={{fontWeight:'bold',fontSize:20,color: '#ff0000'}}>HEART RATE</Text>
              <Image source={require('../Images/Heart.png')} style={{width:110,height:125,marginTop:0, marginLeft:250}}></Image>
          </View>
        </View>
    </View>
      </View>
